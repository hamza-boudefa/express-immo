...
const NavBar2 = () => {
  ...
  // const Position=navbar==true? Position="none": "fixed"
console.log(navbar)
  return (
    <div className="Navbar"  style={{height:"unset",backgroundImage:'unset'}} >
      <div
        className="v"
        style={{
          backgroundColor: "black" ,
          position: !navbar ? "static" : "fixed",
          transform:!navbar ?'translateY(0%)':'translateY(-40%)',
